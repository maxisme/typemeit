...
swiftc -parse-as-library -O -enable-bare-slash-regex eval.swift "$PP" ../../TypeMeIt/Log.swift ../../TypeMeIt/ModelText.swift ../../TypeMeIt/ScreenContext.swift ../../TypeMeIt/CustomWordMatcher.swift ../../TypeMeIt/LocalCleanup.swift ../../TypeMeIt/WritingStyle.swift -o eval
./eval
